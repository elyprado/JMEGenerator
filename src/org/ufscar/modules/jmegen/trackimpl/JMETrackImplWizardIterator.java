...
//<file name="TrackImp.java" url="nbresloc:/org/ufscar/modules/jmegen/trackimpl/Track.java.tfl">
// TODO define position attribute
//@TemplateRegistration(folder = "JMEGenerator", displayName = "TrackImp.java", iconBase = "org/ufscar/modules/jmegen/icon.png", description = "jMETrackImpl.html", scriptEngine="freemarker")
//@Messages("JMETrackImplWizardIterator_displayName=JME Track Implementation")
public final class JMETrackImplWizardIterator implements WizardDescriptor.InstantiatingIterator<WizardDescriptor> {
...
if (panels == null) {
            ...
            panels.add(new JMETrackImplWizardPanel1(project));
    ...
    public Set<?> instantiate() throws IOException {
        ...
        String content = (String) wizard.getProperty(JMETrackImplVisualPanel1.CONTENT);
        ...
        targetName = (String) wizard.getProperty(JMETrackImplVisualPanel1.FILENAME);
