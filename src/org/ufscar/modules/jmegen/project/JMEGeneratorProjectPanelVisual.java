...
public class JMEGeneratorProjectPanelVisual extends JPanel implements DocumentListener {

    public static final String PROP_PROJECT_NAME = "projectName";
    private JMEGeneratorProjectWizardPanel panel;
 
    public JMEGeneratorProjectPanelVisual(JMEGeneratorProjectWizardPanel panel) {
        initComponents();
        this.panel = panel;
    ...
    void read(WizardDescriptor settings) {
        ...
        if (projectName == null) {
            projectName = "JMEGeneratorProject";
        }
